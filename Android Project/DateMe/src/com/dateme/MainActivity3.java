...
public class MainActivity3 extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setReadPermissions(Arrays.asList("public_profile","email","user_likes", "user_status"));

        loginButton.setUserInfoChangedCallback(new LoginButton.UserInfoChangedCallback() {
            @Override
            public void onUserInfoFetched(GraphUser user) {
                MainActivity3.this.user = user;
                System.out.println("------------------------------");
                if(user!=null){
...
//                Toast toast = Toast.makeText(MainActivity3.this, text, Toast.LENGTH_SHORT);
//                toast.show();
//            }
//        });
//
